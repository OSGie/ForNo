...
export const PLANS: Plan[] = [
  {
    ...
    files: "1 ملف ضريبي", users: "1 مستخدم", features: ["24 نقطة مجانية للعمليات", "فروع غير محدودة", "لوحة متابعة أساسية"], decisionCue: "ابدأ بالأساسيات، ثم أضف أدوات الإصدار عند الحاجة.",
  },
  {
    ...
    files: "1 ملف ضريبي", users: "2 مستخدمين", featured: true, recommended: true, badge: "الخيار الأنسب للإصدار", features: ["9600 نقطة إصدار متضمنة", "إصدار الفواتير والإيصالات", "1 جهاز POS", "فروع غير محدودة"], decisionCue: "اختيار أوفر إذا كنت ستصدر فواتير أو إيصالات بانتظام.",
  },
  {
    ...
    files: "10 ملفات ضريبية", users: "2 مستخدمين", features: ["إدارة ملفات العملاء في مكان واحد", "تنزيل ومراجعة منظمة", "صلاحيات لفريق المكتب"], decisionCue: "انقل أول 10 ملفات من المتابعة اليدوية لمسار منظم.",
  },
  {
    ...
    files: "25 ملفًا ضريبيًا", users: "4 مستخدمين", features: ["كل ما في المحترف", "15 ملفًا إضافيًا", "2 مستخدمين إضافيين"], decisionCue: "مناسبة حين يصبح توزيع المتابعة بين أكثر من محاسب ضرورة.",
  },
  {
    ...
    files: "50 ملفًا ضريبيًا", users: "6 مستخدمين", features: ["كل ما في الخبير", "25 ملفًا إضافيًا", "2 مستخدمين إضافيين"], decisionCue: "خفّف التشتت عندما يكبر عدد الملفات النشطة في المكتب.",
  },
  {
    sku: "elite", persona: "firm", name: "باقة النخبة", description: "أعلى سعة لاستيعاب محفظة عملاء واسعة وفريق أكبر.", annualPiastres: 250000,
    files: "100 ملف ضريبي", users: "10 مستخدمين", featured: true, recommended: true, badge: "أفضل قيمة للمكاتب", features: ["كل ما في الاستشاري", "50 ملفًا إضافيًا", "4 مستخدمين إضافيين"], decisionCue: "اخترها عندما تكون الأولوية لاستيعاب النمو دون تغيير الباقة سريعًا.",
  },
];
